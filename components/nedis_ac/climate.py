...
AirConditioner = nedis_ac_ns.class_("NedisAC", climate.Climate, cg.Component)
Capabilities = nedis_ac_ns.namespace("Constants")
...
# Actions
FollowMeAction = nedis_ac_ns.class_("FollowMeAction", automation.Action)
DisplayToggleAction = nedis_ac_ns.class_("DisplayToggleAction", automation.Action)
SwingStepAction = nedis_ac_ns.class_("SwingStepAction", automation.Action)
BeeperOnAction = nedis_ac_ns.class_("BeeperOnAction", automation.Action)
BeeperOffAction = nedis_ac_ns.class_("BeeperOffAction", automation.Action)
PowerOnAction = nedis_ac_ns.class_("PowerOnAction", automation.Action)
PowerOffAction = nedis_ac_ns.class_("PowerOffAction", automation.Action)
PowerToggleAction = nedis_ac_ns.class_("PowerToggleAction", automation.Action)
